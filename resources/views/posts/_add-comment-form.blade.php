@auth
		...
		@else
			...
			<p>
				...
				<a href="/register" class="hover:underline text-blue-500 text-xs font-bold uppercase">Register</a> or <a href="/login" class="hover:underline text-blue-500 text-xs font-bold uppercase">Log In</a> to leave a comment? 
